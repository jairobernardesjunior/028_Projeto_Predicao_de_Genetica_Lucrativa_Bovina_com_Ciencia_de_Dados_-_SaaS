...
def atualizar_descricoes_piquetes():
    try:
        ...
        sql_update = """
            UPDATE cadastro_piquete 
            SET descricao = 'piquete ' || CAST(id_piquete AS TEXT)
        """
        ...
        print(f"Sucesso! {linhas_afetadas} piquetes foram atualizados.")
